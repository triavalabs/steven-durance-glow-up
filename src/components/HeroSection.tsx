      ...
      <div className="relative z-10 container mx-auto px-6 pt-8 pb-12 md:pt-20 md:pb-0">
        <div className="max-w-6xl mx-auto text-center">
          ...
          animationDelay: "0.6s"
            ...
            <Button variant="cta" size="xxl" className="shadow-glow" aria-label="Book free strategy call with Steven Durance" onClick={() => window.open('https://funnels.stevendurance.com/book', '_blank')}>
              Find Your Plan
            </Button>
          </div>
